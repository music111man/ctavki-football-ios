...
extension IAPManager: SKProductsRequestDelegate {
    ...
    func request(_ request: SKRequest, didFailWithError error: Error) {
        printAppEvent("Error load products: \(error)")
    }
}
...
//        printAppEvent("receiptValidationStarted")
//        
//        receipt = IAPReceipt()
//        
...
//            
//            printAppEvent("receiptProcessingFailure")
//            return false
//        }
//        
//        createValidatedPurchasedProductIds(receipt: receipt)
//        printAppEvent("receiptProcessingSuccess")
//        return true
//    }
...
//            printAppEvent("purchasedProductsValidatedAgainstReceipt")
//            return
//        }
//        
    ...
    func receiptAppStoreValidation() {
        ...
        if FileManager.default.fileExists(atPath: receiptPath) {
            ...
            do {
                ...
                printAppEvent("ERROR receiptValidation: \(error.localizedDescription)")
            }
            ...
            do {
                ...
                guard let validationURL = URL(string: validationURLString) else { printAppEvent("the validation url could not be created, unlikely error"); return }
                                ...
                                if let status = appReceiptJSON["status"] as? Int {
                                    ...
                                    if receiptStatus.isValid {
                                        ...
                                        if appReceiptJSON["latest_receipt"] != nil {
                                            ...
                                            printAppEvent(latestReceipt)
                                        }
                                    } else {
                                        printAppEvent("receipt not valid")
                                    }
                                }
                            }
